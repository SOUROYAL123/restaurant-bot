/**
 * ═══════════════════════════════════════════════════════════════════════
 * WHATSAPP CLINIC BOT v8.2.0 - WITH QR CODE CLINIC SELECTION
 * 
 * ✅ WhatsApp Appointment Booking
 * ✅ QR Code Direct Clinic Selection (NEW!)
 ...
 * ✅ Security Hardened
 * ✅ Production Ready
 * ✅ WEBHOOK FIX - /webhook endpoint added
 * 
 * NEW in v8.2.0:
 * - QR Code automatic clinic selection via code
 * - Scales to 1000+ clinics
 * - Database-driven clinic routing
 * 
 * Author: Sourav Roy - Legacylens Automation
 * Modified: 2026-01-15 - QR Code Feature Added
 * ═══════════════════════════════════════════════════════════════════════
 */
...
async function handleMessage(phone, text) {
    try {
        ...
        // ═══════════════════════════════════════════════════════════
        // 🆕 STEP 1: CHECK FOR CLINIC CODE (QR CODE SCAN)
        // ═══════════════════════════════════════════════════════════
        
        // Try to find clinic by code (handles codes like "ZAMZAM", "ABC_DENTAL", etc.)
        const possibleCode = cleanText.replace(/_START$/i, ''); // Remove _START suffix if present
...
// [The rest of the code remains EXACTLY the same - routes, cron, etc.]
// I'm showing only the changed section above
...
// [Copy the rest from your original bot.js - webhooks, sheets API, cron, etc.]
