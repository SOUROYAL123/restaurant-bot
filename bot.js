...
async function handleMessage(phone, text) {
    try {
        ...
        // ═══════════════════════════════════════════════════════
        // BUG FIX: Removed || msg === '1' from restart triggers
        // This was causing "1" to restart instead of selecting clinic #1
        // ═══════════════════════════════════════════════════════
...
app.get('/status', async (req, res) => { 
    try { 
        ...
        `; 
        res.json({ status: 'ok', version: '5.0.1', stats: s[0] || {} }); 
    } catch (e) { 
...
async function startServer() {
    try {
        log.info('Starting v5.0.1 - Bug Fix Release...');
        await sql`SELECT NOW()`;
        log.success('Database connected');
        
        app.listen(PORT, HOST, () => {
            console.log('═══════════════════════════════════════════════════════════');
            console.log('🚀 WHATSAPP CLINIC BOT v5.0.1 - BUG FIX RELEASE');
            console.log('═══════════════════════════════════════════════════════════');
            ...
            console.log(`🔧 Bug Fix:     Clinic selection now works ✅`);
            console.log('═══════════════════════════════════════════════════════════');
